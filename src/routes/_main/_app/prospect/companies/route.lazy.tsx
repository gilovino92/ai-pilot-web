...
import { columns } from "@/app/prospect/CompanyColumns";
...
export const Route = createLazyFileRoute("/_main/_app/prospect/companies")({
...
function RouteComponent() {
  ...
  const { data: companies, isFetching } = useQuery(
    companiesQueryOptions(pagination, filters),
  );
              ...
              <CollapsibleContent className="mt-1 space-y-1">
                <Input
                  onChange={(e) =>
                    setFilters((prev) => ({
                      ...prev,
                      retail_location_min: e.target.value,
                    }))
                  }
                  placeholder="Min"
                  value={filters?.retail_location_min || ""}
                />
                <Input
                  onChange={(e) =>
                    setFilters((prev) => ({
                      ...prev,
                      retail_location_max: e.target.value,
                    }))
                  }
                  placeholder="Max"
                  value={filters?.retail_location_max || ""}
                />
              </CollapsibleContent>
            </Collapsible>
          </ScrollArea>
